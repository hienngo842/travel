...
.primary-checkbox input:checked + label {
  background: url("/assets/img/elements/primary-check.png") no-repeat center
    center/cover;
  border: none;
}
.confirm-checkbox {
...
.confirm-checkbox input:checked + label {
  background: url("/assets/img/elements/success-check.png") no-repeat center
    center/cover;
  border: none;
}
.disabled-checkbox {
...
.disabled-checkbox input:checked + label {
  background: url("/assets/img/elements/disabled-check.png") no-repeat center
    center/cover;
  border: none;
}
.primary-radio {
...
.primary-radio input:checked + label {
  background: url("/assets/img/elements/primary-radio.png") no-repeat center
    center/cover;
  border: none;
}
.confirm-radio {
...
.confirm-radio input:checked + label {
  background: url("/assets/img/elements/success-radio.png") no-repeat center
    center/cover;
  border: none;
}
.disabled-radio {
...
.disabled-radio input:checked + label {
  background: url("/assets/img/elements/disabled-radio.png") no-repeat center
    center/cover;
  border: none;
}
.default-select {
